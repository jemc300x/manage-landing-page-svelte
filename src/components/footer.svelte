...
<section class="footer">
  <form class="form">
    ...
    <button type="button" id="submit" class="btn orange" on:click={handleClick}>GO</button>
    {#if showMessageError}
